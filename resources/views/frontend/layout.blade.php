          ...
          <div class="site-navigation">
            <div class="row g-0 align-items-center">
              ...
              <div class="col-2 text-end">
                ...
                <form action="{{url('blog')}}" method="GET" class="search-form d-none d-lg-inline-block">
                  <input
                    type="text"
                    class="form-control"
                    placeholder="Search..."
              ...
              <div class="post-entry-footer">
                <ul>
                  <li>
                    <a href="">
                      <img
                        src="{{ asset( 'blogy/images/img_1_sq.jpg') }}"
                  ...
                  <li>
                    <a href="">
                      <img
                        src="{{ asset( 'blogy/images/img_2_sq.jpg') }}"
                        alt="Image placeholder"
                        class="me-4 rounded"
                      />
                      <div class="text">
                  ...
                  <li>
                    <a href="">
                      <img
                        src="{{ asset( 'blogy/images/img_3_sq.jpg') }}"
                        alt="Image placeholder"
                        class="me-4 rounded"
                      />
                      <div class="text">
